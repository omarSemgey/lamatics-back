    ...
    public function rules()
    {
        ...
        return [
            'quiz_title'  => [
                ...
                'max:50',
                'min:3',
                Rule::unique('quizzes')->ignore($id, $primaryKey),
            ],
            'quiz_description' => 'sometimes|regex:/\S/|string|min:3|max:100',
            'quiz_difficulty' => 'sometimes|regex:/\S/|in:1,2,3',

            'questions' => 'required|array|min:1|max:50',
            'questions.*.quiz_question_id' => 'nullable|exists:quiz_questions,quiz_question_id',
            ...
            'questions.*.answers.*.question_answer_id' => 'nullable|exists:quiz_question_answers,question_answer_id',
